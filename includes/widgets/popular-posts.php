...
class sodathemes_widget_popular_posts extends WP_Widget {

	public function __construct() {
		$widget_details = array(
			'classname' => 'vlt_widget_popular_posts',
			'description' => esc_html__( 'Shows popular posts.', 'sodathemes' )
		);
		parent::__construct( 'sodathemes_widget_popular_posts', esc_html__( 'SODAThemes: Popular Posts', 'sodathemes' ), $widget_details );
	}
