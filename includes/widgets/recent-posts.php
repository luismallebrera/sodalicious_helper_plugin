...
class sodathemes_widget_recent_posts extends WP_Widget {

	public function __construct() {
		$widget_details = array(
			'classname' => 'vlt_widget_recent_posts',
			'description' => esc_html__( 'Shows recent posts.', 'sodathemes' )
		);
		parent::__construct( 'sodathemes_widget_recent_posts', esc_html__( 'SODAThemes: Recent Posts', 'sodathemes' ), $widget_details );
	}
