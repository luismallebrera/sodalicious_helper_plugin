...
class Widget_SODAThemes_Showcase_3 extends Widget_Base {

	public function get_name() {
		return 'vlt-showcase-3';
	}

	public function get_title() {
		return esc_html__( 'Showcase Style 3', 'sodathemes' );
	}
				...
				<?php foreach ( $settings[ 'items' ] as $item ) :
					...
					<div class="swiper-slide">
						...
						<div class="vlt-showcase-item">
							...
							<div class="vlt-showcase-content" data-swiper-parallax="-150" data-swiper-parallax-opacity="0" data-swiper-parallax-duration="1000">
