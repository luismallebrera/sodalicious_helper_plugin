...
class Widget_SODAThemes_Showcase_10 extends Widget_Base {

	public function get_name() {
		return 'vlt-showcase-10';
	}

	public function get_title() {
		return esc_html__( 'Showcase Style 10', 'sodathemes' );
	}
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			'height', [
				...
				'selectors' => [
					'{{WRAPPER}} .swiper-wrapper, {{WRAPPER}} .vlt-showcase-item' => 'height: {{SIZE}}{{UNIT}}; min-height: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			'padding', [
				...
				'selectors' => [
					...
					'{{WRAPPER}} .vlt-showcase-link' => 'bottom: {{BOTTOM}}{{UNIT}};'
				],
			]
		);
		...
		$this->add_control(
			'overlay_background_color', [
				...
				'selectors' => [
					'{{WRAPPER}} .vlt-showcase-image::before' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			'overlay_background_color_hover', [
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .vlt-showcase-item:hover .vlt-showcase-image::before' => 'background-color: {{VALUE}};',
				],
			]
		);
						...
						<div class="vlt-showcase-item">
							...
							<div class="vlt-showcase-content">
								...
								<?php if ( $item[ 'link' ][ 'url' ] ) : ?>
									...
									<a class="vlt-showcase-link" <?php echo $this->get_render_attribute_string( $link_key ); ?>><i class="ri-arrow-right-line"></i></a>
