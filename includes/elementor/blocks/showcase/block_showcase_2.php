...
class Widget_SODAThemes_Showcase_2 extends Widget_Base {

	public function get_name() {
		return 'vlt-showcase-2';
	}

	public function get_title() {
		return esc_html__( 'Showcase Style 2', 'sodathemes' );
	}
	...
	protected function register_controls() {
		...
		$repeater->add_control(
			'section_color', [
				'label' => esc_html__( 'Section Color', 'sodathemes' ),
		...
		$this->add_responsive_control(
			'height', [
				...
				'selectors' => [
					'{{WRAPPER}} .vlt-showcase-item, {{WRAPPER}} .swiper-wrapper' => 'height: {{SIZE}}{{UNIT}}; min-height: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			'padding', [
				...
				'selectors' => [
					'{{WRAPPER}} .vlt-showcase-item' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			'number_color', [
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .vlt-showcase-content::before' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			Group_Control_Typography::get_type(), [
				...
				'selector' => '{{WRAPPER}} .vlt-showcase-content::before',
			]
		);
			...
			<div class="swiper-wrapper">
				...
				<?php foreach ( $settings[ 'items' ] as $item ) :
					...
					<div class="swiper-slide">
						...
						<div class="vlt-showcase-item" style="<?php echo $item[ 'section_color' ] ? 'background-color: ' . $item[ 'section_color' ] . ';' : ''; ?>">
							...
							<div class="container">
								...
								<div class="row">
									...
									<div class="col-md-6 d-block">
										...
										<div class="vlt-showcase-content" data-number="<?php echo $item[ 'number' ]; ?>">

											<div data-swiper-parallax="-150" data-swiper-parallax-duration="1000">
