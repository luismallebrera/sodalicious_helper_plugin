...
class Widget_SODAThemes_Showcase_4 extends Widget_Base {

	public function get_name() {
		return 'vlt-showcase-4';
	}

	public function get_title() {
		return esc_html__( 'Showcase Style 4', 'sodathemes' );
	}
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			'height', [
				...
				'selectors' => [
					'{{WRAPPER}} .vlt-project-showcase' => 'height: {{SIZE}}{{UNIT}}; min-height: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			'overlay_background_color', [
				...
				'selectors' => [
					'{{WRAPPER}} .vlt-showcase-images::before' => 'background-color: {{VALUE}};',
				],
			]
		);
