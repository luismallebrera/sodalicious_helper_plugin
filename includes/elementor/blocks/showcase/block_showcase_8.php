...
class Widget_SODAThemes_Showcase_8 extends Widget_Base {

	public function get_name() {
		return 'vlt-showcase-8';
	}

	public function get_title() {
		return esc_html__( 'Showcase Style 8', 'sodathemes' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'number_color', [
				...
				'selectors' => [
					'{{WRAPPER}} .vlt-showcase-number' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			Group_Control_Typography::get_type(), [
				...
				'selector' => '{{WRAPPER}} .vlt-showcase-number',
			]
		);
						...
						<div class="swiper-slide">
							...
							<div class="vlt-showcase-item">
								...
								<?php if ( $item[ 'image' ][ 'url' ] ) : ?>
									...
									<div class="vlt-showcase-image" style="background-image: url(<?php echo wp_get_attachment_image_src( $item[ 'image' ][ 'id' ], $item[ 'image_size' ] )[0]; ?>);"></div>

								<?php endif; ?>

								<div class="vlt-showcase-content">

									<span class="vlt-showcase-number"><?php echo str_pad( $index, 2, '0', STR_PAD_LEFT ); ?></span>
