...
class Widget_SODAThemes_Showcase_5 extends Widget_Base {

	public function get_name() {
		return 'vlt-showcase-5';
	}

	public function get_title() {
		return esc_html__( 'Showcase Style 5', 'sodathemes' );
	}
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			'height', [
				...
				'selectors' => [
					'{{WRAPPER}} .vlt-project-showcase__item, {{WRAPPER}} .swiper-wrapper' => 'height: {{SIZE}}{{UNIT}}; min-height: {{SIZE}}{{UNIT}};',
				],
			]
		);
