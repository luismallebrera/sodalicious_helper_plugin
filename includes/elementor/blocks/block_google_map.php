...
class Widget_SODAThemes_Google_Map extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Google Map', 'sodathemes' );
	}

	public function get_icon() {
		return 'eicon-google-maps sodathemes-badge';
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'section_' . $first_level++, [
				'label' => esc_html__( 'Google Map', 'sodathemes' ),
			]
		);
		...
		$this->add_control(
			'lat', [
				'label' => esc_html__( 'Latitude', 'sodathemes' ),
		...
		$this->add_control(
			'lng', [
				'label' => esc_html__( 'Longitude', 'sodathemes' ),
				'description' => __( '<a href="https://www.latlong.net/" target="_blank">Here is a tool</a> where you can find Latitude &amp; Longitude of your location.' ),
				'type' => Controls_Manager::TEXT,
		...
		$this->add_control(
			'zoom', [
				'label' => esc_html__( 'Zoom Level', 'sodathemes' ),
		...
		$this->add_control(
			'map_type', [
				'label' => esc_html__( 'Map Type', 'sodathemes' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'roadmap' => esc_html__( 'Road Map', 'sodathemes' ),
					'satellite' => esc_html__( 'Satellite', 'sodathemes' ),
					'hybrid' => esc_html__( 'Hybrid', 'sodathemes' ),
					'terrain' => esc_html__( 'Terrain', 'sodathemes' ),
				],
				'default' => 'roadmap',
				'separator' => 'before',
			]
		...
		$this->add_control(
			'gesture_handling', [
				'label' => esc_html__( 'Gesture Handling', 'sodathemes' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'auto' => esc_html__( 'Auto', 'sodathemes' ),
					'cooperative' => esc_html__( 'Cooperative', 'sodathemes' ),
					'greedy' => esc_html__( 'Greedy', 'sodathemes' ),
		...
		$this->add_control(
			'zoom_control', [
				'label' => esc_html__( 'Zoom Control', 'sodathemes' ),
		...
		$this->add_control(
			'zoom_control_position', [
				'label' => esc_html__( 'Control Position', 'sodathemes' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'RIGHT_BOTTOM' => esc_html__( 'Bottom Right', 'sodathemes' ),
					'TOP_LEFT' => esc_html__( 'Top Left', 'sodathemes' ),
					'TOP_CENTER' => esc_html__( 'Top Center', 'sodathemes' ),
					'TOP_RIGHT' => esc_html__( 'Top Right', 'sodathemes' ),
					'LEFT_CENTER' => esc_html__( 'Left Center', 'sodathemes' ),
					'RIGHT_CENTER' => esc_html__( 'Right Center', 'sodathemes' ),
					'BOTTOM_LEFT' => esc_html__( 'Bottom Left', 'sodathemes' ),
					'BOTTOM_CENTER' => esc_html__( 'Bottom Center', 'sodathemes' ),
					'BOTTOM_RIGHT' => esc_html__( 'Bottom Right', 'sodathemes' ),
				],
		...
		$this->add_control(
			'default_ui', [
				'label' => esc_html__( 'Default UI', 'sodathemes' ),
				'type' => Controls_Manager::SWITCHER,
				'return_value' => 'yes',
				'default' => 'yes',
				'separator' => 'before',
		...
		$this->add_control(
			'map_type_control', [
				'label' => esc_html__( 'Map Type Control', 'sodathemes' ),
				'type' => Controls_Manager::SWITCHER,
				'return_value' => 'yes',
				'default' => 'yes',
				'separator' => 'before',
		...
		$this->add_control(
			'map_type_control_style', [
				'label' => esc_html__( 'Control Style', 'sodathemes' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'DEFAULT' => esc_html__( 'Default', 'sodathemes' ),
					'HORIZONTAL_BAR' => esc_html__( 'Horizontal Bar', 'sodathemes' ),
					'DROPDOWN_MENU' => esc_html__( 'Dropdown Menu', 'sodathemes' ),
				],
				'default' => 'DEFAULT',
				'condition' => [
		...
		$this->add_control(
			'map_type_control_position', [
				...
				'type' => Controls_Manager::SELECT,
				'options' => [
					'TOP_LEFT' => esc_html__( 'Top Left (Default)', 'sodathemes' ),
					'TOP_CENTER' => esc_html__( 'Top Center', 'sodathemes' ),
					'TOP_RIGHT' => esc_html__( 'Top Right', 'sodathemes' ),
					'LEFT_CENTER' => esc_html__( 'Left Center', 'sodathemes' ),
					'RIGHT_CENTER' => esc_html__( 'Right Center', 'sodathemes' ),
		...
		$this->add_control(
			'streetview_control', [
				'label' => esc_html__( 'Streetview Control', 'sodathemes' ),
				'type' => Controls_Manager::SWITCHER,
				'return_value' => 'yes',
				'separator' => 'before'
			]
		...
		$this->add_control(
			'streetview_control_position', [
				'label' => esc_html__( 'Streetview Position', 'sodathemes' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'RIGHT_BOTTOM' => esc_html__( 'Bottom Right (Default)', 'sodathemes' ),
					'TOP_LEFT' => esc_html__( 'Top Left', 'sodathemes' ),
					'TOP_CENTER' => esc_html__( 'Top Center', 'sodathemes' ),
					'TOP_RIGHT' => esc_html__( 'Top Right', 'sodathemes' ),
					'LEFT_CENTER' => esc_html__( 'Left Center', 'sodathemes' ),
		...
		$this->add_control(
			'map_style', [
				'label' => esc_html__( 'Map Style', 'sodathemes' ),
		...
		$this->start_controls_section(
			'section_' . $first_level++, [
				'label' => esc_html__( 'Marker Pins', 'sodathemes' ),
			]
		);
		...
		$repeater->add_control(
			'pin_icon', [
				'label' => esc_html__( 'Marker Icon', 'sodathemes' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'' => esc_html__( 'Default', 'sodathemes' ),
					'custom' => esc_html__( 'Custom', 'sodathemes' ),
				],
			]
		);
		...
		$this->add_control(
			'pins', [
				'label' => esc_html__( 'Pins', 'sodathemes' ),
		...
		$this->start_controls_section(
			'section_' . $first_level++, [
				'label' => esc_html__( 'Info Window', 'sodathemes' ),
		...
		$this->add_responsive_control(
			'delayainfo_window_content_align', [
				...
				'options' => [
					...
					'justify' => [
						'title' => esc_html__( 'Justify', 'sodathemes' ),
